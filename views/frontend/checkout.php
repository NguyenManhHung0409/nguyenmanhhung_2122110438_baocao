...
if (isset($_POST['XACNHAN']) && count($listcart)>0) {
   ...
   if ($order->save()) {
      foreach ($listcart as $cart) {
         ...
         $orderdetail->save();    //Lưu lại những lần thực hiện
      }
      unset($_SESSION['cart']);  //Lưu thành công xoá giỏ hàng
               ...
               <?php if (isset($_SESSION["iscustom"])) : ?>
                  ...
                  <div class="thanhtoan mb-4">
                     ...
                     <div class="p-4 border bankinfo">
                        ...
                        <p>Chủ tài khoản: Nguyễn Mạnh Hùng</p>
                     </div>
                  </div>
            ...
            <table class="table table-borderless">
               ...
               <tbody>
                  ...
                  <?php foreach ($listcart as $item) : ?>
                     <?php $monney = $item['price'] * $item['qty']; ?>
                     <tr>
                        <td class="text-center align-middle bg-info"><?= $stt; ?></td>
                        <td>
