...
<body>
   ...
   <section class="nmh-mainmenu bg-main">
      <div class="container">
         <div class="row">
   ...
   <section class="nmh-maincontent py-2">
      <div class="container">
         <div class="row">
            ...
            <div class="col-md-9 order-1 order-md-2">
               <h1 class="fs-2 text-main">Tiêu đề bài viết 1</h1>
               <p>
               ...
               <ul class="post-list-other">
                  <li><a href="post_detail.html">Tiêu đề bài viết 2</a></li>
                  <li><a href="post_detail.html">Tiêu đề bài viết 3</a></li>
                  <li><a href="post_detail.html">Tiêu đề bài viết 4</a></li>
                  <li><a href="post_detail.html">Tiêu đề bài viết 5</a></li>
                  <li><a href="post_detail.html">Tiêu đề bài viết 6</a></li>
                  <li><a href="post_detail.html">Tiêu đề bài viết 7</a></li>
               </ul>
            </div>
         </div>
      </div>
   </section>
   <section class="nmh-footer pb-4">
      <div class="container">
         <div class="row">
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: Trương Thành Đạt - Phone: 0998765432
      </div>
   </section>
</body>
