        ...
        <div class="card-body">
          ...
          <div class="col md-3">
            <div class="mb-3">
              ...
              <input type="text" placeholder="Nhập user name" name="username" value="<?= $user->username; ?>" class='form-control'>
            </div>
            <div class="col mb-3">
              <label>Mật khẩu</label>
              <input type="password " placeholder="Nhập mật khẩu" name="password" value="<?= $user->password; ?>" class='form-control'>
            </div>
            <div class="mb-3">
