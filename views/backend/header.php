...
<body class="nmh-transition sidebar-mini">
   <div class="wrapper">
               ...
               <div class="navbar-search-block">
                  <form class="form-inline">
                     <div class="input-group input-group-sm">
                        <input class="form-control form-control-navbar" type="search" placenmher="Search"
                           aria-label="Search">
    ...
    <a href="index.php" class="brand-link">
     ...
     <span class="brand-text font-weight-light text-center"><h3>Quản trị</h3></span>
   </a>
